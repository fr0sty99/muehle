...
public class GameView {
	...
	public GameView(int gridViewWidth, int gridViewHeight) {
		...
		view = new JPanel();
		view.setPreferredSize(new Dimension(gridViewWidth, gridViewHeight));
		

		// // setting up boardPanel TODO
		// Dimension boardPanelDimension = new Dimension(gridViewWidth,
		// gridViewHeight);
		...
		// // adding gridPanel and PlayerPanel to this (JSplitPane) TODO
	...
	public void drawPiecesOnPlayerPanel(Player[] players) {
		...
		for (int i = 0; i < players[0].getPiecesToSet(); i++) {
			...
			leftGraphics.fillOval(x + playerPanelOffSetX, y + playerPanelOffSetY, playerPanelPieceSize,
					playerPanelPieceSize);
		...
		for (int i = 0; i < players[1].getPiecesToSet(); i++) {
			...
			rightGraphics.fillOval(x + playerPanelOffSetX, y + playerPanelOffSetY, playerPanelPieceSize,
					playerPanelPieceSize);
			x += playerPanelPieceDist;
		}
	}
	...
	public void addMyMouseListener(MouseListener mouseListener) {
		// addMouseListener(mouseListener); TODO
	}
	...
	public void drawGridWithPieces(NodeSet[] sets) {
		...
		g.clearRect(0, 0, gridPanel.getWidth(), gridPanel.getHeight()); // clear
																		// panel
